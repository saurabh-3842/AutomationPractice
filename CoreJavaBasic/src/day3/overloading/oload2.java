...
public class oload2 {
		...
		public static void main(String[] args) {
			...
			System.out.println("sum:2 "+oload2.addNumbers(45,55));
			System.out.println("sum:3 "+addNumbers(47,53,58));
			System.out.println("sum:4 "+oload2.addNumbers(47,53.56,58));
			System.out.println("sum:5 "+oload2.addNumbers(47.14,53,58));
		}
